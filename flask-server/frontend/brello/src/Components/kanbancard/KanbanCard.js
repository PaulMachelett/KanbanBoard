...
import jsonData from "./DummyKanban.json";
import CommentElement from "../comment/Comment.js";
const Kanbancard = () => {
            ...
            .map((card) => (
              ...
              >
                ...
                <CardActions>
                  <Button
                    size="small"
                    onClick={() => openCardInWindow(card.id)}
                  >
                    Open Card
                  </Button>
                </CardActions>
        ...
        >
          {selectedCard && (
            ...
            >
              ...
              <br></br>
              <Button variant="contained" onClick={closeCardModal}>
                Close
              </Button>
            </div>
          )}
